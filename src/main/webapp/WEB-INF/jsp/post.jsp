...
<body>
    ...
    <header class="intro-header" style="background-image: url('https://raw.githubusercontent.com/origoni/spring-blog/master/src/main/resources/static/image/post-bg.jpg')">
        <div class="container">
            <div class="row">
